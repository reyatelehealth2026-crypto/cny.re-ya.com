<?php
/**
 * CRM Dashboard - ศูนย์กลางจัดการลูกค้า
 */
...
$stmt->execute([$currentBotId, $currentBotId]);
$stats['new_7days'] = $stmt->fetchColumn();
...
try {
    ...
    $stmt->execute([$currentBotId]);
    $stats['auto_rules'] = $stmt->fetchColumn();
} catch (Exception $e) {
    $stats['auto_rules'] = 0;
}
...
<div class="mb-6">
    <h2 class="text-2xl font-bold">📊 CRM Dashboard</h2>
    <p class="text-gray-600">จัดการลูกค้าและระบบ Auto Tag</p>
</div>
    ...
    <div class="bg-white rounded-xl shadow p-4">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold"><?php echo number_format($stats['total_customers']); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-4">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold"><?php echo number_format($stats['new_today']); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-4">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold"><?php echo number_format($stats['total_tags']); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-4">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold"><?php echo number_format($stats['auto_rules']); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="mt-6 bg-white rounded-xl shadow p-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <a href="crm-analytics.php" class="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
