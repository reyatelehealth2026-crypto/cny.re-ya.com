...
<div class="flex justify-between items-center mb-6">
    <div>
        <h2 class="text-2xl font-bold">📊 CRM Analytics</h2>
        <p class="text-gray-600">วิเคราะห์ข้อมูลลูกค้า</p>
    </div>
    <div class="flex gap-2">
        <a href="?days=7" class="px-4 py-2 rounded-lg <?= $days == 7 ? 'bg-blue-500 text-white' : 'bg-gray-100 hover:bg-gray-200' ?>">7 วัน</a>
        <a href="?days=30" class="px-4 py-2 rounded-lg <?= $days == 30 ? 'bg-blue-500 text-white' : 'bg-gray-100 hover:bg-gray-200' ?>">30 วัน</a>
        <a href="?days=90" class="px-4 py-2 rounded-lg <?= $days == 90 ? 'bg-blue-500 text-white' : 'bg-gray-100 hover:bg-gray-200' ?>">90 วัน</a>
    </div>
</div>
