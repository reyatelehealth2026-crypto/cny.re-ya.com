...
require_once 'classes/DynamicRichMenu.php';

$db = Database::getInstance()->getConnection();
$pageTitle = 'Dynamic Rich Menu';
...
<div class="bg-white rounded-xl shadow mb-6">
    <div class="border-b">
        <nav class="flex -mb-px">
            <button onclick="showTab('rules')" id="tab-rules" class="tab-btn px-6 py-4 border-b-2 border-green-500 text-green-600 font-medium">
                <i class="fas fa-cogs mr-2"></i>กฎการกำหนด
            </button>
            <button onclick="showTab('manual')" id="tab-manual" class="tab-btn px-6 py-4 border-b-2 border-transparent text-gray-500 hover:text-gray-700">
                <i class="fas fa-user-cog mr-2"></i>กำหนดรายบุคคล
            </button>
            <button onclick="showTab('bulk')" id="tab-bulk" class="tab-btn px-6 py-4 border-b-2 border-transparent text-gray-500 hover:text-gray-700">
                <i class="fas fa-users-cog mr-2"></i>กำหนดแบบกลุ่ม
            </button>
            <button onclick="showTab('stats')" id="tab-stats" class="tab-btn px-6 py-4 border-b-2 border-transparent text-gray-500 hover:text-gray-700">
    ...
    <!-- Rules Tab -->
    <div id="content-rules" class="tab-content p-6">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <form method="POST" class="inline" onsubmit="return confirm('ลบกฎนี้?')">
    ...
    <div id="content-manual" class="tab-content p-6 hidden">
    ...
    <!-- Bulk Assignment Tab -->
    <div id="content-bulk" class="tab-content p-6 hidden">
