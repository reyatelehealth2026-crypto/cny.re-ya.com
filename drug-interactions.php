    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">
                <i class="fas fa-pills text-purple-500 mr-2"></i>จัดการยาตีกัน
            </h1>
            <p class="text-gray-500 mt-1">ฐานข้อมูล Drug Interactions</p>
        </div>
        <button onclick="showAddModal()" class="px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600">
...
<div id="addModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
    <div class="fixed inset-0 bg-black/50" onclick="hideAddModal()"></div>
        ...
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-lg">
            ...
            <form method="POST" class="p-6">
                ...
                <div class="flex gap-3">
                    <button type="button" onclick="hideAddModal()" class="flex-1 py-2 bg-gray-100 text-gray-700 rounded-lg">
                        ยกเลิก
                    </button>
