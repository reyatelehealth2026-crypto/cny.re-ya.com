...
- [x] 1. Project Setup and Core Infrastructure
  ...
  - [ ]* 1.3 Write property test for touch target minimum size
...
- [x] 4. Home Dashboard (Telecare Style)
  ...
  - [ ]* 4.3 Write property test for QR code validity
    - **Property 8: QR Code Validity**
    - **Validates: Requirements 5.3**
  - [ ]* 4.4 Write property test for tier progress bounds
...
- [x] 5. Shop Page - Product Catalog
  ...
  - [ ]* 5.3 Write property test for product card required elements
    - **Property 3: Product Card Required Elements**
    - **Validates: Requirements 2.3**
  - [ ]* 5.4 Write property test for prescription badge display
  ...
  - [x] 5.6 Implement floating cart summary bar
    ...
    - _Requirements: 2.5_
  - [ ]* 5.7 Write property test for cart summary visibility
  ...
  - [x] 5.8 Implement infinite scroll pagination
    ...
    - _Requirements: 2.6_
  - [ ]* 5.9 Write property test for infinite scroll loading
...
- [x] 7. Cart and Checkout
  ...
  - [ ]* 7.3 Write property test for cart serialization round-trip
  ...
  - [ ]* 7.5 Write property test for auto-fill from LINE profile
  ...
  - [ ]* 7.7 Write property test for form validation state consistency
  ...
  - [ ]* 7.10 Write property test for promo code validation response
...
- [x] 9. Drug Interaction System
  ...
  - [x] 9.1 Create drug interaction checker service
    ...
    - _Requirements: 12.1_
  - [ ]* 9.2 Write property test for drug interaction check trigger
  ...
  - [x] 9.4 Implement severe interaction blocking
    ...
    - _Requirements: 12.4_
  - [ ]* 9.5 Write property test for severe interaction block
  ...
  - [x] 9.6 Implement moderate interaction acknowledgment
    ...
    - _Requirements: 12.5_
  - [ ]* 9.7 Write property test for moderate interaction acknowledgment
...
- [x] 10. Prescription Drug Flow
  ...
  - [ ]* 10.3 Write property test for prescription checkout block
  ...
  - [ ]* 10.5 Write property test for prescription approval expiry
...
- [x] 12. Order History and Tracking
  ...
  - [x] 12.1 Create order history page
    ...
    - _Requirements: 4.1_
  - [ ]* 12.2 Write property test for order history sorting
...
- [x] 15. LIFF-to-Bot Message Bridge
  ...
  - [ ]* 15.2 Write property test for LIFF message sending
